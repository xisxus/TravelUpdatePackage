...
namespace TravelUpdate.Controllers
{
    ...
    public class PackageController : ControllerBase
    {
        ...
        [HttpGet("get-package-details/{packageId}")]
        ...
        [HttpPut("update-package-details/{packageDetailsId}")]
        public async Task<IActionResult> UpdatePackageDetails(int packageDetailsId, [FromBody] PackageDetailsInsertModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            var packageDetails = await _context.PackageDetails.FindAsync(packageDetailsId);
        ...
        [HttpGet("get-package-includes/{packageId}")]
        ...
        [HttpPut("update-package-include/{includeId}")]
        public async Task<IActionResult> UpdatePackageInclude(int includeId, [FromBody] PackageIncludesUpdateModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("delete-package-include/{includeId}")]
        ...
        [HttpGet("get-package-excludes/{packageId}")]
        ...
        [HttpPut("update-package-exclude/{excludeId}")]
        public async Task<IActionResult> UpdatePackageExclude(int excludeId, [FromBody] PackageExcludesUpdateModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpDelete("delete-package-exclude/{excludeId}")]
